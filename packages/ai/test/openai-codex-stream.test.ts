...
const originalAgentDir = process.env.JSMART_CODING_AGENT_DIR;

afterEach(() => {
	global.fetch = originalFetch;
	if (originalAgentDir === undefined) {
		delete process.env.JSMART_CODING_AGENT_DIR;
	} else {
		process.env.JSMART_CODING_AGENT_DIR = originalAgentDir;
	}
	vi.restoreAllMocks();
});
...
describe("openai-codex streaming", () => {
	it("streams SSE responses into AssistantMessageEventStream", async () => {
		...
		process.env.JSMART_CODING_AGENT_DIR = tempDir;
